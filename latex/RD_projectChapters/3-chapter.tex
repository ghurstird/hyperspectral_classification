...
\begin{itemize}
    ...
    \item Providing a graphical user interface (GUI) operating on a multithreaded architecture to allow simultaneous testing and real-time prediction of developed models \cite{fedosejev2015react}.
\end{itemize}
